...
const OptionBar:React.VFC = () => {
  ...
  const using_horizontal = renderData.args['horizontal_orientation'];
  ...
  const horientation = {'item': 'table','parent': 'block'};
  const vorientation = {'item': 'flex','parent': 'flex'};
  ...
  const setTheme = () => {
    let merged_theme = {'menu_background': '#F0F2F6','txc_inactive': '#FFFFFF','txc_active': '#FFFFFF','option_active': '#F63366', 'padding-top': '0rem', 'comp_width': 'auto'};
    ...
    return ":root {--menu_background: " + merged_theme.menu_background +
     ";--txc_inactive: " +merged_theme.txc_inactive + 
     ";--txc_active:" + merged_theme.txc_active + 
     ";--comp_width:" + merged_theme.comp_width + 
     ";--item-display:" + orientation.item + 
     ";--parent-display:" + orientation.parent + 
  ...
  const complex_nav = () => {
    return (
      ...
      <nav className="navbar navbar-mainbg parent">
        <div className="navbar parent" id="navbarSupportedContent">
            <ul className="navbar-nav" style={{display:orientation.item}}>
